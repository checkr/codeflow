...
var describeArrayInsert = function describeArrayInsert(reducer, expect, _ref) {
  ...
  return function () {
    it('should work with empty state', function () {
      var state = reducer(undefined, (0, _actions.arrayInsert)('foo', 'myField', 0, 'myValue'));
    ...
    it('should insert at beginning', function () {
      ...
      }), (0, _actions.arrayInsert)('foo', 'myField.subField', 0, 'newValue'));
      expect(state).toEqualMap({
        foo: {
          values: {
            myField: {
    ...
    it('should insert at end', function () {
      ...
      }), (0, _actions.arrayInsert)('foo', 'myField.subField', 3, 'newValue'));
      expect(state).toEqualMap({
        foo: {
          values: {
            myField: {
    ...
    it('should insert in middle', function () {
      ...
      }), (0, _actions.arrayInsert)('foo', 'myField.subField', 1, 'newValue'));
      expect(state).toEqualMap({
        foo: {
          values: {
            myField: {
...
exports.default = describeArrayInsert;