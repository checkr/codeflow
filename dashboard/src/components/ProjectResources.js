...
class ProjectResources extends Component {
  constructor(props) {
    ...
    this.onCancelEditService = this.onCancelEditService.bind(this)
        ...
        <div className="feed-element">
          <div className="media-body ">
            <ProjectServiceForm
              ...
              onCancel={this.onCancelEditService}
        ...
        <div className="feed-element">
          <div className="media-body ">
            <Extension
              ...
              onSave={this.onSaveExtension}
              onCancel={this.onCancelEditExtension}
              onDelete={this.onDeleteExtension}
            />
          </div>
        </div>
      </li>
